...
@property (nonatomic, retain) UIView *bodyView;              //照片瀑布流视图
@property (nonatomic, assign) id<ZBWaterViewDelegate> waterDelegate;
@property (nonatomic, assign) id<ZBWaterViewDatasource> waterDataSource;
@property (nonatomic, retain) CustomWaterInfo *waterInfo;
