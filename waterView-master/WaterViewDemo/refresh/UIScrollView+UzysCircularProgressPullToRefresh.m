...
- (void)addPullToRefreshActionHandler:(actionHandler)handler
{
    if(self.pullToRefreshView == nil)
    {
        ...
        UzysRadialProgressActivityIndicator *view = [[UzysRadialProgressActivityIndicator alloc] init];
        view.pullToRefreshHandler = handler;
        view.scrollView = self;
        view.frame = CGRectMake(self.frame.size.width/2.0f - view.bounds.size.width/2.0f,
