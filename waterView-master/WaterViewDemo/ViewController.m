...
@interface ViewController ()<ZBWaterViewDatasource,ZBWaterViewDelegate,MJRefreshBaseViewDelegate>
{
...
//    _header.scrollView = _waterView;
    ...
    __block __weak typeof (ZBWaterView) *_blockself = _waterView;
    [_waterView addPullToRefreshActionHandler:^{
    
        [_blockself reloadData];
    }];
    [_waterView setPullToLoadMoreHandler:^{
        [_blockself reloadData];
    }];
...
{
    [_waterView stopRefreshAnimation];
