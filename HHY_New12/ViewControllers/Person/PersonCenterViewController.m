...
-(void)createScreen
{
    ...
    returnLoginButton.frame = CGRectMake(60, 260, 200, 40);
...
-(void)logExit
{
    UIAlertView *alt = [[UIAlertView alloc]initWithTitle:nil message:@"是否退出" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
    [[CustomArltView customArlt]showAlertView:alt didClick:^(NSInteger buttonIndex) {
        if(buttonIndex == 1)
        {
