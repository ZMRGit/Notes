...
-(void)createScreen
{
    NSArray *nameArray = @[@"姓          名", @"乘机人类型",@"性          别", @"证 件 类 型", @"证 件 号 码", @"出 生 日 期",  @"手          机",@"邮          箱"];
 ...
 view1 = [[CustomView alloc] initWithFrame:CGRectMake(0, 20, 320, 240)];
    ...
    _certTypeButton = [[SelectTypeButton alloc] initWithFrame:CGRectMake(130, 90, 180, 30)];
    ...
    _certNumTF = [[UITextField alloc] initWithFrame:CGRectMake(130, 120, 180, 30)];
    ...
    _birthdayTF = [[SelectTypeButton alloc] initWithFrame:CGRectMake(130, 150, 180, 30)];
//    _birthdayTF.typeLable.text = _model.birthday;
    ...
    _sexTF = [[SelectTypeButton alloc] initWithFrame:CGRectMake(130, 60, 180, 30)];
    _sexTF.tag = 300;
