...
-(void)createView
{
    ...
    UILabel *phonelabel = [[UILabel alloc]initWithFrame:CGRectMake(180, size.height + 71, 140, 25)];
    phonelabel.textColor = kADWColor(44, 172, 230, 1);
    phonelabel.font = [UIFont systemFontOfSize:12];
    phonelabel.text = [NSString stringWithFormat:@"电话: %@",[_detailDic objectForKey:@"tel"]];
    [_introView addSubview:phonelabel];
