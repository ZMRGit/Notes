...
-(void)isopenApp
{
    MKNetworkEngine *mkEngine = [[MKNetworkEngine alloc]initWithHostName:@"www.lecuan.com"];
    MKNetworkOperation *op = [mkEngine operationWithPath:@"/api-giveUWant.html" params:nil httpMethod:@"GET"];
