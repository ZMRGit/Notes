...
+(NSString *)payType:(NSString *)state
{
    ...
    [dic setObject:@"待支付" forKey:@"0"];
     [dic setObject:@"公司付款" forKey:@"4"];
     [dic setObject:@"支付宝支付" forKey:@"5"];
     [dic setObject:@"银联支付" forKey:@"6"];
...
+(NSString *)orderState:(NSString *)state
{
    ...
    //    14 审批拒绝X
    [array replaceObjectAtIndex:14 withObject:@"审批拒绝"];
    //    7 导入
    ...
    //    19 已退款
    [array replaceObjectAtIndex:19 withObject:@"已退款"];
    //    20 已退票
    ...
    //  15 改期已拒绝
    [array replaceObjectAtIndex:15 withObject:@"改期拒绝"];
    //  15 退票拒绝
    [array replaceObjectAtIndex:16 withObject:@"退票拒绝"];
    //    92 OPEN
