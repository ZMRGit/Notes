...
- (void)loadView
{
    ...
    expressionBtn.frame = CGRectMake(0.0f, 45.0f, 106.0f, 30.0f);
    ...
    attachBtn.frame = CGRectMake(106.0f, 45.0f, 107.0f, 30.0f);
    ...
    voiceBtn.frame = CGRectMake(213.0f, 45.0f, 107.0f, 30.0f);
